# PowerBi-HotelBookings-Dashboard
This project analyzes hotel booking patterns and customer loyalty to help optimize revenue management and marketing strategies. The dashboard provides insights into:
Booking Volume Over Time: Tracking the number of stays per day and identifying peak seasons (e.g., the notable increase in early-mid October).
